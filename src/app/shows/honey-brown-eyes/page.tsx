  ...
  const castCrewContent = (
    <div className="space-y-4 text-gray-300">
      <div className="grid gap-3">
        <div><span className="font-medium">Amela Karadža</span> - Director/Alma</div>
        <div><span className="font-medium">John Wicks</span> - Assistant Director</div>
        <div><span className="font-medium">Trevor Ferguson</span> - Dragan</div>
        <div><span className="font-medium">Mirza Šuman</span> - Zlata</div>
        <div><span className="font-medium">Majda Zahić</span> - Radio Broadcaster</div>
        <div><span className="font-medium">Terri Dillion</span> - Jovanka</div>
        <div><span className="font-medium">Francisco Negron</span> - Denis</div>
        <div><span className="font-medium">Jovani Zambrano</span> - Sound Designer/Branko</div>
        <div><span className="font-medium">Lexi Johns</span> - Stage Manager</div>
        <div><span className="font-medium">Ellie Wirth</span> - Prop Designer/ASM</div>
        <div><span className="font-medium">Anthony Parry</span> - Musician/Composer</div>
        <div><span className="font-medium">Mike Ward</span> - Musician/Composer</div>
        <div><span className="font-medium">Lauryn Mederios</span> - Musician/Composer</div>
        <div><span className="font-medium">Sabina Selimović</span> - Singer</div>
      </div>
    </div>
  )
