 ...
 const productionDetailsContent = (
  <div className="space-y-6 text-gray-300">
    ...
    <div>
      ...
      <p className="text-xs text-gray-400 mt-1">Doors open 1 hour before start</p>
    </div>
      <div>
    ...
    <div className="min-h-screen bg-black">
      ...
      <ShowMediaSection>
        <div className="relative aspect-[16/9]">
         <Image
  src="/images/sanctuary-city-poster.webp"
...
/>
      ...
      <ShowDateVenue dates="May 7-9, 14-17, 2026" venue="The Lounge, 2417 Bank Dr, Boise, ID 83705" />
...
>
  <div className="text-center mb-6">
    <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-accent/30 mb-4">
    ...
    <p className="text-gray-300 text-base md:text-lg leading-relaxed mb-4">
      Little Branch Theater invites you to audition for <em>Sanctuary City</em> and future productions.
    </p>
    <p className="text-gray-300 text-sm mb-2">
      <strong>Location:</strong> Xanadu (5015 Bond St, Boise, Idaho 83706)
    </p>
    <p className="text-gray-300 text-sm mb-6">
      <strong>What to prepare:</strong> 60-90 second contemporary monologue
    </p>
  </div>
